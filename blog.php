...
<div id="loginForm" class="loginForm">
    ...
    <label for="username">Username:</label><br>
        <input style="font-size: 14px;" type="text" name="uname" required><br>
        <label for="password">Password:</label><br>
        <input style="font-size: 14px;"type="password" name="pword" required><br>
        <input style="font-size: 14px;" class="submit" type="submit" value="Login" name='login'>
        <button style="font-size: 14px;" type="button" class="cancel" onclick="closeForm()">Close</button>
</form>
</div>
...
<div class="tab">
  <button style="font-family: 'Georgia', sans-serif" class="tablinks" onclick="openTab(event, 'Post1')" id="1"><b>Post 1</b> <br> Lorem ipsum dolor sit amet, consec...</button>
  <button style="font-family: 'Georgia', sans-serif" class="tablinks" onclick="openTab(event, 'Post2')" id="2"><b>Post 2</b> <br> Lorem ipsum dolor sit amet, consec...</button>
  <button style="font-family: 'Georgia', sans-serif" class="tablinks" onclick="openTab(event, 'Post3')" id="3"><b>Post 3</b> <br> Lorem ipsum dolor sit amet, consec...</button>
  <button style="font-family: 'Georgia', sans-serif" class="tablinks" onclick="openTab(event, 'Post4')" id="4"><b>Post 4</b> <br> Lorem ipsum dolor sit amet, consec...</button>
</div>
...
<div id="Post1" class="tabcontent" style="font-family: 'Montserrat';font-size: 20px;"><br><br>
 <br> <h2 style="text-align: center;">Post 1</h2>
...
<br><br>Aenean ut dictum sapien, et vehicula quam. Curabitur ut orci nec justo sollicitudin tincidunt in venenatis massa. Duis quis tortor gravida, molestie elit in, vestibulum dui. Donec porttitor vitae enim eu cursus. Mauris nec turpis ligula. Sed non porttitor nisl. Sed dignissim iaculis libero, at rutrum libero ultrices eget. In tempus, lectus quis commodo convallis, dolor sapien sollicitudin elit, at sollicitudin felis risus nec massa. Proin in mi ut libero mollis eleifend sed eget libero. Donec sit amet tellus ante. Etiam consequat ante ipsum, at vehicula lectus luctus at. Pellentesque vel tincidunt dui. Curabitur ligula neque, tincidunt nec vulputate ut, hendrerit in augue. Vestibulum sed lobortis ante, ac dapibus nisi. Sed et neque nec augue sodales varius et eu augue. Aliquam pellentesque dolor in neque condimentum pretium.</p>
  ...
  if($comResults->num_rows >0){ ?>
    <h3>Comments:</h3> <?php
  }else{
    ?>
    <h3>No comments to display!</h3> <?php
  }
  while($rowData = $comResults->fetch_assoc()){?>
    <div style="width: 60%; padding: 8px; margin-left:20px; text-indent: 10px;
...
<input style="cursor: pointer; font-size: 18px; background-color: #04AA6D; color: white;" type="submit" value="Submit Comment" name="submitCom1" onclick="return confirm('Are you sure you want to submit this comment?')">
...
<div id="Post2" class="tabcontent" style="font-family: 'Montserrat';font-size: 20px;"><br><br>
  <br><h2 style="text-align: center;">Post 2</h2>
...
<input style="cursor: pointer; font-size: 18px; background-color: #04AA6D; color: white;" type="submit" value="Submit Comment" name='submitCom2' onclick="return confirm('Are you sure you want to submit this comment?')"> 
...
<div id="Post3" class="tabcontent" style="font-family: 'Montserrat';font-size: 20px;"><br><br>
  <br><h2 style="text-align: center;">Post 3</h2>
...
<input style="cursor: pointer; font-size: 18px; background-color: #04AA6D; color: white;" type="submit" value="Submit Comment" name='submitCom3' onclick="return confirm('Are you sure you want to submit this comment?')">
...
<div id="Post4" class="tabcontent" style="font-family: 'Montserrat';font-size: 20px;"><br><br>
 <br> <h2 style="text-align: center;">Post 4</h2>
...
<input style="cursor: pointer; font-size: 18px; background-color: #04AA6D; color: white;" type="submit" value="Submit Comment" name='submitCom4' onclick="return confirm('Are you sure you want to submit this comment?')">
